...
for (let commandAndUnits of commandReadings) {
  if (commandAndUnits[0] === 'forward') {
    horizontalPos += commandAndUnits[1]
    depth += aim * commandAndUnits[1]
  }
  if (commandAndUnits[0] === 'up') aim -= commandAndUnits[1]
  if (commandAndUnits[0] === 'down') aim += commandAndUnits[1]
}
